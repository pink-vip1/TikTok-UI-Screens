...
const followingData = [
  {
    ...
    username: '@nguoiban_01',
    caption: 'Video từ những người bạn đang follow ✨\n#friendship #xuhuong',
  ...
  },
  {
    ...
    username: '@idol_tiktok',
    caption: 'Hôm nay trời đẹp quá! ☀️\n#vlog #daily',
    music: 'Happy Day - Sun',
    likes: '1.5M',
    comments: '20K',
    bookmarks: '100K',
  ...
  return (
    <View style={styles.videoContainer}>
      <VideoView
        style={styles.video}
        player={player}
        fullscreenOptions={{ allowsFullscreen: false }}  // <-- ĐÃ SỬA
